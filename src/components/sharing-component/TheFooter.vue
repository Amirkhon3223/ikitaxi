<template>
  <div class="bg-secondary" id="footer">
    <div class="max-w-7xl mx-auto py-10 md:px-10 sm:px-5 lg:px-5 px-5">
      <div class="grid grid-cols-1 sm:grid-cols-3 justify-center mb-5 gap-6">
      ...
      <p class="text-xs text-center text-white pt-3">
  ...
  data() {
    return {
     currentYear: new Date().getFullYear(),
      ...
      links: [
        { name: "navbar.links.0.name", link: "/" }, // Ссылка на другую страницу
        { name: "navbar.links.1.name", scrollId: "services" }, // Используйте якорь
        { name: "navbar.links.2.name", scrollId: "advantage" }, // Используйте якорь
        { name: "navbar.links.3.name", scrollId: "tariffs" }, // Используйте якорь
      ],
      contacts: [
